...
sender = st.text_input('Insert here the sender ID')

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver = st.text_input('Insert here the receiver ID')

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount = st.text_input('Insert here the amount to be transfered')
